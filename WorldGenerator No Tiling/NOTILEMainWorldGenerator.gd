...
var landmassMap = preload('res://01 - landmass_map/NOTILELandmassGenerator.tscn')
var faultlineMap = preload('res://02 - faultline_map/NOTILEFaultlineGenerator.tscn')
var landmassFaultlineComposite = preload('res://03 - landmass_faultline_composite/NOTILELandmassFaultlineComposite.tscn')
var humidityMap = preload('res://04 - humidity_map/NOTILEHumidityMap.tscn')
var rainfallMap = preload("res://05 - rainfall_map/NOTILERainfallMap.tscn")
var biomeGenerator = preload('res://06 - BiomeGenerator/NOTILEBiomeGenerator.tscn')
var waterBiomeUniqueColors = preload('res://07 - WaterBiomeUniqueColors/NOTILEWaterBiomeUniqueColors.tscn')
var waterBiomeLevel = preload("res://08 - WaterBiomeLevel/NOTILEWaterBiomeLevel.tscn")
var landmassFlatWaterBiomes = preload('res://09 - landmass_flat_water_biomes/NOTILELandmassFlatWaterBiomes.tscn')
var landmassWaterBiomeTextures = preload("res://10 - WaterBiomeTextures/NOTILEWaterBiomeTextures.tscn")
